...
import com.tapaafandi.dicoflix.data.source.remote.RemoteDataSource.LoadMoviesCallback
import com.tapaafandi.dicoflix.data.source.remote.RemoteDataSource.LoadTvShowsCallback
...
class DicoflixRepository private constructor(private val remoteDataSource: RemoteDataSource): DicoflixDataSource {

    companion object {
        @Volatile
        private var instance: DicoflixRepository? = null

        fun getInstance(remoteData: RemoteDataSource): DicoflixRepository =
            instance ?: synchronized(this) {
                instance ?: DicoflixRepository(remoteData)
            }
    }
